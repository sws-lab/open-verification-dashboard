<script lang="ts">
	...
	let filterErrorTypesOptions: Record<string, boolean> = $state({
		...
		'Signed integer overflow in arithmetic operator': true,
		'Unsigned integer overflow in arithmetic operator': true,
		'Signed integer overflow in explicit cast': true,
		'Unsigned integer overflow in explicit cast': true,
		'Signed integer overflow in implicit cast': true,
		'Unsigned integer overflow in implicit cast': true,
